...
| antyteza inwersyjna forma B: [określnik] X to Y, nie Z (kopuła „to", podmiot 1-2 wyrazy niezaimkowe). Wyklucza: dokładne formy czasowników biorących „to"-dopełnienie, dni tygodnia i liczby w orzeczniku (korekty faktualne). ZNANE OGRANICZENIE: korekty faktualne z rzeczownikiem pospolitym (np. „Piotr to kierownik, nie pracownik") są strukturalnie nieodróżnialne bez analizy POS — domena Stage 2. | `(?:(?<=^)\|(?<=[.!?;:\n]))\s*(?!(?:zostaw\|zostawia\|zostawiam\|pamiętaj\|pamięta\|zrób\|zrobił\|zrobiła\|zrobili\|dostał\|dostała\|dostałem\|weź\|daj\|dał\|dała\|kup\|kupił\|kupuje\|rób\|robi\|robił\|miej\|napisz\|przeczytaj\|widzę\|widzi\|widział\|lubię\|lubi\|mam\|masz\|ma\|chcę\|chce\|wolę\|woli)\b)[A-Za-ząćęłńóśźżĄĆĘŁŃÓŚŹŻ][a-ząćęłńóśźż]{2,}(?: (?-i:[a-ząćęłńóśźż]{3,}))? to (?!(?:poniedziałek\|wtorek\|środ\w+\|czwartek\|piątek\|sobot\w+\|niedziel\w+)\b)(?!\d)(?-i:[a-ząćęłńóśźż]{3,})(?:\s+(?-i:[a-ząćęłńóśźż]{3,}))?,\s+nie\s+(?-i:[a-ząćęłńóśźż]{3,})(?=[.!?;\n]\|$)` |
