...
Dostępne też jako podkomenda dispatchera: `miodek build-dict` (KAN-232).
...
Użycie:
    miodek build-dict KORPUS... [--min-count N] [--min-files M]
...
from miodek import ai_linter  # compile_markers do veta kanonu
